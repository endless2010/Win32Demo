					...
					LPSTR lpCmdLine,int iShowCmd)
{
	...
	hwnd=CreateWindow(szAppName,TEXT("BigJob1 multithread Demo"),WS_OVERLAPPEDWINDOW,
...
LRESULT CALLBACK WndProc(HWND hwnd,UINT iMsg,WPARAM wParam,LPARAM lParam)
{
	...
	static TCHAR* szMessage[]={TEXT("Ready(left mouse button begins)"),
		                       TEXT("Working(Working(right mouse button ends)"),
							   TEXT("%d repetitions in %ld mses")};
